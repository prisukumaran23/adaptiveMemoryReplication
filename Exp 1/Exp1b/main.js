    // Recognition memory study DAY 1 (experiment 2 over two days)
   ...
   add_phase_data_recog = function(stimuli){
    ...
    var welcome = {
        type: "instructions",
        pages:[
          "<p> Welcome to day 1 of the guessing game.</p>"+
         ...
         "<p><br>This is a 2 day study which aims to investigate how people learn new words."+
         "<p>Today, you will complete 3 phases with breaks in between.</p>"+
            ...
            "<br>and the total reward you earn will be your bonus payment.</p>"+
              "<p>Following 3 phases of guessing, you will be asked to complete a survey about your mood.",
              ...
              "<p>On day 2, you will be asked to complete another survey.",
              "<p>Today's session should take about 15 minutes, and day 2 should take about 25 minutes.</p>"+
    ...
    end_timeline.push({
      type: 'call-function',
      func: function(){
        saveData("Recog_Memory_Day1_Json", jsPsych.data.get().json());
      }
      });
  ...
  timeline.push(initiate,phase1,phase2,phase3,survey,end)
